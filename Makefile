...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Nov 19 15:33:31 2014
# Project:  catwalk.pro
# Template: app
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib -lGLU -L/v/filer4b/v20q001/santiago/cs395t/catwalk/catwalk-code/SOIL/lib -lSOIL -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		collisions/CTCD.cpp \
		clothtemplate.cpp \
		clothinstance.cpp moc_mainwindow.cpp \
		moc_glpanel.cpp \
		moc_controller.cpp
OBJECTS       = main.o \
		mainwindow.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/catwalk1.0.0/ && $(COPY_FILE) --parents mainwindow.h glpanel.h controller.h simulation.h simparameters.h mesh.h rigidbodytemplate.h rigidbodyinstance.h vectormath.h camera.h rotator.h signeddistancefield.h collisions/Distance.h collisions/CTCD.h clothtemplate.h clothinstance.h .tmp/catwalk1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp glpanel.cpp controller.cpp simulation.cpp simparameters.cpp mesh.cpp rigidbodytemplate.cpp rigidbodyinstance.cpp vectormath.cpp camera.cpp rotator.cpp signeddistancefield.cpp collisions/CTCD.cpp clothtemplate.cpp clothinstance.cpp .tmp/catwalk1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/catwalk1.0.0/ && (cd `dirname .tmp/catwalk1.0.0` && $(TAR) catwalk1.0.0.tar catwalk1.0.0 && $(COMPRESS) catwalk1.0.0.tar) && $(MOVE) `dirname .tmp/catwalk1.0.0`/catwalk1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/catwalk1.0.0
...
libSOIL:
	cd /v/filer4b/v20q001/santiago/cs395t/catwalk/catwalk-code/SOIL/projects/makefile/ && make
...
clothtemplate.o: clothtemplate.cpp clothtemplate.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o clothtemplate.o clothtemplate.cpp

clothinstance.o: clothinstance.cpp clothinstance.h \
		clothtemplate.h \
		mesh.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o clothinstance.o clothinstance.cpp
